...
namespace PerformanceCalculatorGUI.Screens.ObjectInspection.BlueprintObjects
{
    public partial class InspectorSliderSelectionBlueprint : OsuSelectionBlueprint<Slider>
    {
        ...
        public InspectorSliderSelectionBlueprint(Slider slider)
            : base(slider)
        {
        }
